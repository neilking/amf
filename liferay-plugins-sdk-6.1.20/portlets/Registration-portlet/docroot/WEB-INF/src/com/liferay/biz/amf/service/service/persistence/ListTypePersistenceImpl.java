...
import com.liferay.biz.amf.service.NoSuchListTypeException;
import com.liferay.biz.amf.service.model.ListType;
import com.liferay.biz.amf.service.model.impl.ListTypeImpl;
import com.liferay.biz.amf.service.model.impl.ListTypeModelImpl;
...
public class ListTypePersistenceImpl extends BasePersistenceImpl<ListType>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_N_T = new FinderPath(ListTypeModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_N_T = new FinderPath(ListTypeModelImpl.ENTITY_CACHE_ENABLED,
			ListTypeModelImpl.FINDER_CACHE_ENABLED, ListTypeImpl.class,
	...
	public ListType remove(long listTypeId)
		...
		return remove(Long.valueOf(listTypeId));
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ListType> findByN_T(String name, String type)
		throws SystemException {
		return findByN_T(name, type, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ListType> findByN_T(String name, String type, int start, int end)
		throws SystemException {
		return findByN_T(name, type, start, end, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ListType> findByN_T(String name, String type, int start,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ListType findByN_T_First(String name, String type,
		OrderByComparator orderByComparator)
		throws NoSuchListTypeException, SystemException {
		ListType listType = fetchByN_T_First(name, type, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ListType fetchByN_T_First(String name, String type,
		OrderByComparator orderByComparator) throws SystemException {
		List<ListType> list = findByN_T(name, type, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ListType findByN_T_Last(String name, String type,
		OrderByComparator orderByComparator)
		throws NoSuchListTypeException, SystemException {
		ListType listType = fetchByN_T_Last(name, type, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ListType fetchByN_T_Last(String name, String type,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByN_T(name, type);

		List<ListType> list = findByN_T(name, type, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ListType[] findByN_T_PrevAndNext(long listTypeId, String name,
		...
		try {
			...
			array[0] = getByN_T_PrevAndNext(session, listType, name, type,
					orderByComparator, true);

			array[1] = listType;

			array[2] = getByN_T_PrevAndNext(session, listType, name, type,
	...
	protected ListType getByN_T_PrevAndNext(Session session, ListType listType,
		String name, String type, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByN_T(String name, String type) throws SystemException {
		for (ListType listType : findByN_T(name, type)) {
			remove(listType);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByN_T(String name, String type) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.biz.amf.service.model.ListType")));
